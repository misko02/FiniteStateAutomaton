...
- ZipCodeAutomaton.txt - Automaton accepting Polish zip codes - Example of DFA
- BinaryAutomaton.txt - Automaton accepting binary strings with substrings "01" and "10" - Example of NFA
- numberParser.txt - Automaton accepting floating point numbers with or without leading sign - Example of NFA with
  epsilon transitions
...
Procedure of loading non-deterministic automaton is very similar to loading deterministic automaton, with some
...
4. The last step will be to specify delta function
    * This step is the most different from loading a deterministic automaton
        * First of all, for each state and character of the alphabet, we can specify the number of states to which the
